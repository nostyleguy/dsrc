...
public class component_rename_handler extends script.base_script
{
    public component_rename_handler()
    {
    }
    public int handleSetComponentName(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        {
            detachScript(self, space_crafting.SCRIPT_COMPONENT_RENAME_HANDLER);
